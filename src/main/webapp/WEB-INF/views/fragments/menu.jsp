...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.inventor" access="hasRole('Inventor')">
			...
			<acme:menu-suboption code="master.menu.inventor.chimpum-dashboard" action="/inventor/chimpum-dashboard/show"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.patron" access="hasRole('Patron')">
			...
			<acme:menu-suboption code="master.menu.patron.chimpum-dashboard" action="/patron/chimpum-dashboard/show"/>
		</acme:menu-option>
