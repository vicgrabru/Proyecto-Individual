...
@Service
public class InventorChimpumDashboardShowService implements AbstractShowService<Inventor, ChimpumDashboard>{
	
	// Internal state ---------------------------------------------------------
	
	@Autowired	
	InventorChimpumDashboardRepository repository;
